...
const portfolioProjects = [
  {
    ...
    thumbnail: "/nighttime/images/portfolio-1-en.jpg", // Updated path
    url: "https://TheRebbesGuests.com/en",
    ...
    images: [
      "/nighttime/images/portfolio-1-en.jpg" // Only using the main image for now
    ],
    testimonial: {
